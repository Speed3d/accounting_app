...
///////////////////////////////////////////////////////////////
  ...
  await db.execute('CREATE INDEX IF NOT EXISTS idx_products_unit ON Store_Products(UnitID)');
    ...
    // ============================================================================
    // ✅✅✅ التعديل الرابع: إضافة نظام السنوات المالية (v6) للتثبيت الجديد ✅✅✅
    // ============================================================================
    // ← Hint: إنشاء جداول نظام السنوات المالية للمستخدمين الجدد
    // ← Hint: بدون هذا، المستخدمون الجدد لن يحصلوا على جداول TB_FiscalYears و TB_Transactions
    // ← Hint: هذا يضمن أن التثبيت الجديد = الترقية من حيث البنية النهائية
    if (version >= 6) {
      debugPrint('📦 [DatabaseHelper] إنشاء جداول نظام السنوات المالية (v6) للتثبيت الجديد...');
      await DatabaseMigrations.migrateToV6(db);
      debugPrint('✅ [DatabaseHelper] تم إنشاء نظام السنوات المالية بنجاح! 🎉');
    }
