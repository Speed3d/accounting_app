...
import 'package:accounting_app/services/biometric_service.dart'; // ✅ Hint: إضافة
...
return Scaffold(
  ...
  body: ListView(
    ...
    children: [
      ...
      _buildSectionHeader(
        context,
        title: l10n.currency, // ✅ Hint: سنضيفها في الترجمة
      ...
      _buildSectionHeader(
        context,
        title: l10n.security, // ✅ Hint: سنضيفها في الترجمة
        icon: Icons.security,
        isDark: isDark,
      ),
      const SizedBox(height: AppConstants.spacingSm),
      ...
      _SettingsCard(
        child: _buildBiometricTile(context, l10n, isDark),
      ),
...
return ListTile(
  ...
  onTap: () {
    // ✅ Hint: عرض قائمة العملات
    _showCurrencyDialog(context, l10n, isArabic);
  },
);
}
// ============================================================
// 🔐 بناء خيار تفعيل البصمة (جديد)
// ============================================================
...
title: Text(
l10n.biometricLogin, // ✅ Hint: سنضيفها في الترجمة
style: Theme.of(context).textTheme.titleMedium?.copyWith(
fontWeight: FontWeight.w600,
),
),
subtitle: Text(
_isBiometricEnabled
? l10n.biometricEnabled // ✅ Hint: سنضيفها في الترجمة
: l10n.biometricDisabled, // ✅ Hint: سنضيفها في الترجمة
style: Theme.of(context).textTheme.bodySmall,
),
secondary: Container(
padding: const EdgeInsets.all(AppConstants.spacingSm),
...
title: Text(l10n.selectCurrency), // ✅ Hint: سنضيفها في الترجمة
content: SizedBox(
                ...
                SnackBar(
                  content: Row(
                    children: [
                      const Icon(Icons.check_circle, color: Colors.white),
                      const SizedBox(width: AppConstants.spacingSm),
                      Text(l10n.currencyChanged), // ✅ Hint: سنضيفها في الترجمة
                    ],
                  ),
                  backgroundColor: AppColors.success,
                  behavior: SnackBarBehavior.floating,
...
// في دالة _enableBiometric فقط - استبدلها بهذا:
// ============================================================
...
context: context,
builder: (ctx) => AlertDialog(
title: Text(l10n.disableBiometric), // ✅ Hint: سنضيفها في الترجمة
content: Text(l10n.disableBiometricConfirmation), // ✅ Hint: سنضيفها في الترجمة
actions: [
TextButton(
...
child: Text(l10n.disable), // ✅ Hint: سنضيفها في الترجمة
),
],
),
);
  ...
  SnackBar(
    content: Row(
      children: [
        const Icon(Icons.check_circle, color: Colors.white),
        const SizedBox(width: AppConstants.spacingSm),
        Text(l10n.biometricDisabledSuccess), // ✅ Hint: سنضيفها في الترجمة
      ],
    ),
    backgroundColor: AppColors.success,
    behavior: SnackBarBehavior.floating,
