...
class TransactionService {
  ...
  // ==========================================================================
  // 🔟1 جلب المصروفات العامة من جدول TB_Expenses
  // ==========================================================================

  /// جلب إجمالي المصروفات العامة من جدول TB_Expenses
  ///
  /// ← Hint: هذا جدول منفصل عن TB_Transactions
  /// ← Hint: نجمع البيانات مباشرة من قاعدة البيانات
  Future<Decimal> _getGeneralExpensesFromDB({
    int? fiscalYearId,
    DateTime? startDate,
    DateTime? endDate,
  }) async {
    try {
      ...
      debugPrint('❌ [TransactionService] خطأ في _getGeneralExpensesFromDB: $e');
      return Decimal.zero;
    }
  }

  // ==========================================================================
  // 🔟2 جلب سحوبات الأرباح من جدول TB_Profit_Withdrawals
  // ==========================================================================
